Funcionalidade: Mostrar dados sobre a empresa e desenvolvedores do site
Como um usuário do sistema
Eu quero conseguir ver informações dos criadores e da empresa do site
Para saber quais são os participantes do projeto
